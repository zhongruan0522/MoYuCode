...
export function AboutSection() {
  ...
  const getDownloadUrl = () => {
    ...
    // 根据文件命名规则查找匹配的 asset
    // CI 生成的文件: MoYuCode-{version}-linux-x64.tar.gz, MoYuCode-{version}-osx-x64.tar.gz, MoYuCode-{version}-win-x64.zip
  ...
  const handleDownload = () => {
    ...
    if (downloadUrl.includes('github.com/AIDotNet/MoYuCode')) {
  ...
  return (
    ...
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-semibold mb-2">关于 MoYuCode（摸鱼Coding）</h2>
      ...
      <div className="space-y-4">
        <div className="grid gap-4">
          ...
          <div className="flex items-center justify-between py-3 border-b">
            ...
            <a
              href="https://github.com/AIDotNet/MoYuCode"
              target="_blank"
              rel="noreferrer"
          ...
          <div className="py-3">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              <p>
                MoYuCode（摸鱼Coding）是一个双栈应用程序，为 AI 编码助手（Codex 和 Claude Code）提供 Web UI。
